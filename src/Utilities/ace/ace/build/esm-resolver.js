...
ace.config.setModuleLoader('ace/ext/whitespaces_in_selection', () => import('./src-noconflict/ext-whitespaces_in_selection.js'));
...
ace.config.setModuleLoader('ace/mode/cedar', () => import('./src-noconflict/mode-cedar.js'));
ace.config.setModuleLoader('ace/mode/cedarschema', () => import('./src-noconflict/mode-cedarschema.js'));
...
ace.config.setModuleLoader('ace/mode/groq', () => import('./src-noconflict/mode-groq.js'));
...
ace.config.setModuleLoader('ace/mode/mariadb', () => import('./src-noconflict/mode-mariadb.js'));
...
ace.config.setModuleLoader('ace/snippets/cedar', () => import('./src-noconflict/snippets/cedar.js'));
ace.config.setModuleLoader('ace/snippets/cedarschema', () => import('./src-noconflict/snippets/cedarschema.js'));
...
ace.config.setModuleLoader('ace/snippets/groq', () => import('./src-noconflict/snippets/groq.js'));
...
ace.config.setModuleLoader('ace/snippets/mariadb', () => import('./src-noconflict/snippets/mariadb.js'));
