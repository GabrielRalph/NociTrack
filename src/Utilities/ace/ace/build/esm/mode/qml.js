...
// src/mode/qml_highlight_rules.js
var require_qml_highlight_rules = __commonJS({
  "src/mode/qml_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_qml = __commonJS({
  "src/mode/qml.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var QmlHighlightRules = require_qml_highlight_rules().QmlHighlightRules;
