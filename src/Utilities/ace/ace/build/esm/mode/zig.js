...
// src/mode/zig_highlight_rules.js
var require_zig_highlight_rules = __commonJS({
  "src/mode/zig_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_zig = __commonJS({
  "src/mode/zig.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var ZigHighlightRules = require_zig_highlight_rules().ZigHighlightRules;
