...
// src/mode/asciidoc_highlight_rules.js
var require_asciidoc_highlight_rules = __commonJS({
  "src/mode/asciidoc_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/folding/asciidoc.js
var require_asciidoc = __commonJS({
  "src/mode/folding/asciidoc.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/asciidoc.js
var require_asciidoc2 = __commonJS({
  "src/mode/asciidoc.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var AsciidocHighlightRules = require_asciidoc_highlight_rules().AsciidocHighlightRules;
    var AsciidocFoldMode = require_asciidoc().FoldMode;
    var Mode = function() {
...
export default require_asciidoc2();
