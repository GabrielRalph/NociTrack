...
// src/mode/apache_conf_highlight_rules.js
var require_apache_conf_highlight_rules = __commonJS({
  "src/mode/apache_conf_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_apache_conf = __commonJS({
  "src/mode/apache_conf.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var ApacheConfHighlightRules = require_apache_conf_highlight_rules().ApacheConfHighlightRules;
...
export default require_apache_conf();
