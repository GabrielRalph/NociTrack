...
// src/mode/sparql_highlight_rules.js
var require_sparql_highlight_rules = __commonJS({
  "src/mode/sparql_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_sparql = __commonJS({
  "src/mode/sparql.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var SPARQLHighlightRules = require_sparql_highlight_rules().SPARQLHighlightRules;
