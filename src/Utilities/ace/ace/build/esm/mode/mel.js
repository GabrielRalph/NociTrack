...
// src/mode/mel_highlight_rules.js
var require_mel_highlight_rules = __commonJS({
  "src/mode/mel_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_mel = __commonJS({
  "src/mode/mel.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var MELHighlightRules = require_mel_highlight_rules().MELHighlightRules;
