...
var require_pgsql_highlight_rules = __commonJS({
  "src/mode/pgsql_highlight_rules.js"(exports) {
    var oop = require_oop();
...
var require_pgsql = __commonJS({
  "src/mode/pgsql.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var PgsqlHighlightRules = require_pgsql_highlight_rules().PgsqlHighlightRules;
    var Mode = function() {
