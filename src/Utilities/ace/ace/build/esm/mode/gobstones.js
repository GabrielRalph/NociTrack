...
// src/mode/gobstones_highlight_rules.js
var require_gobstones_highlight_rules = __commonJS({
  "src/mode/gobstones_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_gobstones = __commonJS({
  "src/mode/gobstones.js"(exports) {
    var oop = require_oop();
    var JavaScriptMode = require_javascript().Mode;
    var GobstonesHighlightRules = require_gobstones_highlight_rules().GobstonesHighlightRules;
    var Mode = function() {
