...
// src/layer/gutter.js
var require_gutter = __commonJS({
  "src/layer/gutter.js"(exports) {
    "use strict";
    var dom = require_dom();
    var oop = require_oop();
    ...
    var Marker = class {
      ...
      drawMultiLineMarker(stringBuilder, range, clazz, config, extraStyle) {
        ...
        this.elt(
          ...
          "height:" + height + "px;right:" + padding + "px;top:" + top + "px;left:" + padding + "px;" + (extraStyle || "")
        );
      }
...
var require_scrollbar = __commonJS({
  "src/scrollbar.js"(exports) {
    ...
    var VScrollBar = class extends Scrollbar {
      /**
    ...
    var HScrollBar = class extends Scrollbar {
      /**
...
// src/scrollbar_custom.js
var require_scrollbar_custom = __commonJS({
  "src/scrollbar_custom.js"(exports) {
    "use strict";
    var oop = require_oop();
    var dom = require_dom();
    var event = require_event();
...
var require_font_metrics = __commonJS({
  "src/layer/font_metrics.js"(exports) {
    var oop = require_oop();
    var dom = require_dom();
    var lang = require_lang();
    var event = require_event();
...
var require_editor_css = __commonJS({
  "src/css/editor-css.js"(exports, module) {
    module.exports = `
...
var require_decorators = __commonJS({
  "src/layer/decorators.js"(exports) {
    "use strict";
    var dom = require_dom();
    var oop = require_oop();
    var EventEmitter = require_event_emitter().EventEmitter;
...
var require_virtual_renderer = __commonJS({
  "src/virtual_renderer.js"(exports) {
    "use strict";
    var oop = require_oop();
    var dom = require_dom();
    var lang = require_lang();
    ...
    var VirtualRenderer = class {
      ...
      setGhostText(text, position) {
        ...
        if (textChunks.length > 1) {
          ...
          var lastLineDiv;
          textChunks.slice(1).forEach((el2) => {
      ...
      setTheme(theme, cb) {
        ...
        function afterLoad(module2) {
          if (_self.$themeId != theme)
            return cb && cb();
          if (!module2 || !module2.cssClass)
            throw new Error("couldn't load module " + theme + " or it didn't call define");
          if (module2.$id)
            _self.$themeId = module2.$id;
          dom.importCssString(
            module2.cssText,
            module2.cssClass,
            _self.container
          ...
          var padding = "padding" in module2 ? module2.padding : "padding" in (_self.theme || {}) ? 4 : _self.$padding;
          if (_self.$padding && padding != _self.$padding)
            _self.setPadding(padding);
          if (_self.$gutterLayer) {
            var showGutterCursor = module2["$showGutterCursorMarker"];
          ...
          _self.$theme = module2.cssClass;
          _self.theme = module2;
          dom.addCssClass(_self.container, module2.cssClass);
          dom.setCssClass(_self.container, "ace_dark", module2.isDark);
          if (_self.$size) {
            _self.$size.width = 0;
            _self.$updateSizeAsync();
          }
          _self._dispatchEvent("themeLoaded", { theme: module2 });
          cb && cb();
