...
// src/occur.js
var require_occur = __commonJS({
  "src/occur.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/commands/occur_commands.js
var require_occur_commands = __commonJS({
  "src/commands/occur_commands.js"(exports) {
...
// src/commands/incremental_search_commands.js
var require_incremental_search_commands = __commonJS({
  "src/commands/incremental_search_commands.js"(exports) {
    var config = require_config();
    var oop = require_oop();
    var HashHandler = require_hash_handler().HashHandler;
...
// src/incremental_search.js
var require_incremental_search = __commonJS({
  "src/incremental_search.js"(exports) {
    "use strict";
    ...
    var IncrementalSearch = class extends Search {
       ...
       */
      highlight(regexp) {
        var sess = this.$editor.session, hl = sess.$isearchHighlight = sess.$isearchHighlight || sess.addDynamicMarker(
...
var require_emacs = __commonJS({
  "src/keyboard/emacs.js"(exports) {
    var dom = require_dom();
      ...
      editor.emacsMarkForSelection = function(replacement) {
        ...
        if (replacement) {
          markRing.splice(
            markIndex,
            1,
            "row" in replacement && "column" in replacement ? replacement : void 0
          );
        }
        return lastMark;
      };
    ...
    exports.handler.bindKey = function(key, command) {
      ...
      key.split("|").forEach(function(keyPart) {
        ...
        keyParts.reduce(function(keyMapKeys, keyPart2, i) {
          ...
          if (!ckb[keyPart2]) ckb[keyPart2] = "null";
        });
      }, this);
    };
