...
var require_snippets = __commonJS({
  "src/snippets.js"(exports) {
    ...
    var SnippetManager = class _SnippetManager {
      constructor() {
        this.snippetMap = {};
        this.snippetNameMap = {};
       ...
       */
      getTokenizer() {
        return _SnippetManager["$tokenizer"] || this.createTokenizer();
      }
      createTokenizer() {
        ...
        _SnippetManager["$tokenizer"] = new Tokenizer({
          start: [
        ...
        return _SnippetManager["$tokenizer"];
      }
