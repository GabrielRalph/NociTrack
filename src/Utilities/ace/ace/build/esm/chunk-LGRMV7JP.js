...
var require_search = __commonJS({
  "src/search.js"(exports) {
      ...
      parseReplaceString(replaceString) {
        ...
        for (var i = 0, len = replaceString.length; i < len; i++) {
          ...
          if (chCode === CharCode.DollarSign) {
            ...
            const nextChCode2 = replaceString.charCodeAt(i);
            if (nextChCode2 === CharCode.DollarSign) {
              replacement += "$$";
              continue;
            }
            if (nextChCode2 === CharCode.Digit0 || nextChCode2 === CharCode.Ampersand) {
              replacement += "$&";
              continue;
            }
            if (CharCode.Digit1 <= nextChCode2 && nextChCode2 <= CharCode.Digit9) {
    ...
    function addWordBoundary(needle, options) {
      ...
      function wordBoundary(c, firstChar2 = true) {
...
var require_textinput = __commonJS({
  "src/keyboard/textinput.js"(exports) {
    "use strict";
    ...
    var TextInput = class {
      ...
      constructor(parentNode, host) {
        ...
        event.addListener(this.text, "focus", (e) => {
          ...
          host.onFocus(e);
          if (useragent.isEdge) setTimeout(this.resetSelection.bind(this));
      ...
      addIosSelectionHandler(parentNode, host, text) {
        ...
        var detectArrowKeys = (e) => {
          ...
          if (selectionStart == 0) {
          ...
          } else if (selectionStart < this.lastSelectionStart || selectionStart == this.lastSelectionStart && this.lastSelectionEnd != this.lastSelectionStart && selectionStart == selectionEnd) {
            key = KEYS.left;
            ...
            key = KEYS.right;
            modifier = MODS.option;
          } else if (selectionEnd > this.lastSelectionEnd || selectionEnd == this.lastSelectionEnd && this.lastSelectionEnd != this.lastSelectionStart && selectionStart == selectionEnd) {
            key = KEYS.right;
          }
      ...
      $resetSelection() {
        ...
        var selectionEnd = 0;
        var line = "";
        var positionToSelection = (row2, column) => {
          var selection2 = column;
          for (var i2 = 1; i2 <= row2 - this.rowStart && i2 < 2 * this.numberOfExtraLines + 1; i2++) {
            selection2 += this.host.session.getLine(row2 - i2).length + 1;
          }
          return selection2;
        };
      ...
      moveToMouse(e, bringToFront) {
        ...
        var move = (e2) => {
          dom.translate(this.text, e2.clientX - left - 2, Math.min(e2.clientY - top - 2, maxTop));
        };
        move(e);
...
// src/mouse/default_handlers.js
var require_default_handlers = __commonJS({
  "src/mouse/default_handlers.js"(exports) {
    "use strict";
    var useragent = require_useragent();
    var DRAG_OFFSET = 0;
    var SCROLL_COOLDOWN_T = 550;
    var DefaultHandlers = class {
      /**
...
var require_default_gutter_handler = __commonJS({
  "src/mouse/default_gutter_handler.js"(exports) {
    "use strict";
    var dom = require_dom();
    ...
    var GutterTooltip = class _GutterTooltip extends HoverTooltip {
      /**
       * @param {import("../editor").Editor} editor
       */
      constructor(editor) {
        super(editor.container);
        this.id = "gt" + ++_GutterTooltip.$uid;
        this.editor = editor;
      ...
      showTooltip(row) {
        ...
        if (fold && gutter.$showFoldedAnnotations) {
          ...
          if (["error", "security", "warning"].includes(mostSevereAnnotationTypeInFold)) {
            var summaryFoldedAnnotations = `${_GutterTooltip.annotationsToSummaryString(
              annotationsInFold
            )} in folded code.`;
        ...
        for (var i = 0; i < annotation.displayText.length; i++) {
          ...
          iconElement.setAttribute(
            "aria-label",
            `${_GutterTooltip.annotationLabels[annotation.type[i].replace("_fold", "")].singular}`
          );
      ...
      static annotationsToSummaryString(annotations) {
        ...
        for (var annotationType of annotationTypes) {
          ...
          var label = annotations[annotationType].length === 1 ? _GutterTooltip.annotationLabels[annotationType].singular : _GutterTooltip.annotationLabels[annotationType].plural;
...
// src/mouse/dragdrop_handler.js
var require_dragdrop_handler = __commonJS({
  "src/mouse/dragdrop_handler.js"(exports) {
    "use strict";
    var dom = require_dom();
    var event = require_event();
    var useragent = require_useragent();
    ...
    function DragdropHandler(mouseHandler) {
      ...
      var exports2 = ["dragWait", "dragWaitEnd", "startDrag", "dragReadyEnd", "onMouseDrag"];
      exports2.forEach(function(x2) {
...
var require_touch_handler = __commonJS({
  "src/mouse/touch_handler.js"(exports) {
    "use strict";
    var MouseEvent = require_mouse_event().MouseEvent;
    var event = require_event();
    var dom = require_dom();
...
var require_mouse_handler = __commonJS({
  "src/mouse/mouse_handler.js"(exports) {
    "use strict";
    var event = require_event();
    var useragent = require_useragent();
...
// src/mouse/fold_handler.js
var require_fold_handler = __commonJS({
  "src/mouse/fold_handler.js"(exports) {
    "use strict";
    var dom = require_dom();
...
// src/keyboard/keybinding.js
var require_keybinding = __commonJS({
  "src/keyboard/keybinding.js"(exports) {
    "use strict";
...
// src/commands/default_commands.js
var require_default_commands = __commonJS({
  "src/commands/default_commands.js"(exports) {
    "use strict";
    var lang = require_lang();
    var config = require_config();
    var Range = require_range().Range;
    ...
    exports.commands = [
      {
        ...
        exec: function(editor) {
          config.loadModule("ace/ext/settings_menu", function(module2) {
            module2.init(editor);
      ...
      },
      {
        ...
        exec: function(editor) {
          config.loadModule("ace/ext/error_marker", function(module2) {
            module2.showErrorMarker(editor, 1);
          });
        },
...
var require_gutter_handler = __commonJS({
  "src/keyboard/gutter_handler.js"(exports) {
    "use strict";
    var keys = require_keys();
    var GutterKeyboardHandler = class {
      constructor(editor) {
        this.editor = editor;
    ...
    var Editor = class _Editor {
      ...
      setKeyboardHandler(keyboardHandler, cb) {
        if (keyboardHandler && typeof keyboardHandler === "string" && keyboardHandler != "ace") {
          ...
          var _self = this;
          config.loadModule(["keybinding", keyboardHandler], function(module2) {
            if (_self.$keybindingId == keyboardHandler)
              _self.keyBinding.setKeyboardHandler(module2 && module2.handler);
            cb && cb();
          });
        } else {
      ...
      prompt(message, options, callback) {
        var editor = this;
        config.loadModule("ace/ext/prompt", function(module2) {
          module2.prompt(editor, message, options, callback);
        });
      }
      get hoverTooltip() {
    ...
    var relativeNumberRenderer = {
      ...
      getWidth: function(session, lastLineNumber, config2) {
        return Math.max(
          ...
          (config2.lastRow + 1).toString().length,
          2
        ) * config2.characterWidth;
      },
