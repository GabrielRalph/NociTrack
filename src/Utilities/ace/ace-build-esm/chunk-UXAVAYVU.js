...
// src/ext/modelist.js
var require_modelist = __commonJS({
  "src/ext/modelist.js"(exports) {
    var modes = [];
    ...
    var Mode = class {
       ...
       */
      constructor(name2, caption, extensions) {
        this.name = name2;
    ...
    var modesByName = {};
    for (name in supportedModes) {
      data = supportedModes[name];
