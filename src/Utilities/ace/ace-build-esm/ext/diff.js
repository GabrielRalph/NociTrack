...
var require_scroll_diff_decorator = __commonJS({
  "src/ext/diff/scroll_diff_decorator.js"(exports) {
    var Decorator = require_decorators().Decorator;
    var ScrollDiffDecorator = class extends Decorator {
      /**
...
// src/ext/diff/styles-css.js
var require_styles_css = __commonJS({
  "src/ext/diff/styles-css.js"(exports) {
    exports.cssText = `
/*
 * Line Markers
 */
...
// src/ext/diff/gutter_decorator.js
var require_gutter_decorator = __commonJS({
  "src/ext/diff/gutter_decorator.js"(exports) {
    var dom = require_dom();
    var MinimalGutterDiffDecorator = class {
      /**
...
var require_base_diff_view = __commonJS({
  "src/ext/diff/base_diff_view.js"(exports) {
    "use strict";
    var oop = require_oop();
    ...
    var DiffChunk = class _DiffChunk {
      /**
      ...
      constructor(originalRange, modifiedRange, charChanges) {
        ...
        this.charChanges = charChanges && charChanges.map((m) => new _DiffChunk(
          new Range(
    ...
    var DiffHighlight = class {
      ...
      update(html, markerLayer, session, config2) {
        ...
        lineChanges.forEach((lineChange) => {
          ...
          if (endRow < config2.firstRow || startRow > config2.lastRow)
            return;
          let range2 = new Range(startRow, 0, endRow - 1, 1 << 30);
          if (startRow !== endRow) {
          ...
          if (lineChange.charChanges) {
            for (var i = 0; i < lineChange.charChanges.length; i++) {
              ...
              if (ignoreTrimWhitespace) {
                for (let lineNumber = changeRange.start.row; lineNumber <= changeRange.end.row; lineNumber++) {
                  let startColumn;
                  let endColumn;
                  ...
                  let range3 = new Range(lineNumber, startColumn, lineNumber, endColumn);
                  var screenRange = range3.toScreenRange(session);
                  if (sessionLineStart === startColumn && sessionLineEnd === endColumn) {
                    continue;
                  }
                  let cssClass = "inline " + operation;
                  if (range3.isEmpty() && startColumn !== 0) {
                ...
                var screenRange = range3.toScreenRange(session);
                let cssClass = "inline " + operation;
                if (range3.isEmpty() && changeRange.start.column !== 0) {
...
var require_inline_diff_view = __commonJS({
  "src/ext/diff/inline_diff_view.js"(exports) {
    "use strict";
    var BaseDiffView = require_base_diff_view().BaseDiffView;
    var Renderer = require_virtual_renderer().VirtualRenderer;
    var config = require_config();
    var InlineDiffView = class extends BaseDiffView {
      /**
      ...
      initRenderer(restore) {
        if (restore) {
          ...
          this.editorA.renderer.$getLongestLine = this.editorB.renderer.$getLongestLine = () => {
...
// src/ext/diff/split_diff_view.js
var require_split_diff_view = __commonJS({
  "src/ext/diff/split_diff_view.js"(exports) {
    "use strict";
    var BaseDiffView = require_base_diff_view().BaseDiffView;
    var config = require_config();
    var SplitDiffView = class extends BaseDiffView {
      /**
...
var require_default = __commonJS({
  "src/ext/diff/providers/default.js"(exports) {
    "use strict";
