...
// src/mode/jade_highlight_rules.js
var require_jade_highlight_rules = __commonJS({
  "src/mode/jade_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
    var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
    var MarkdownHighlightRules = require_markdown_highlight_rules().MarkdownHighlightRules;
    var SassHighlightRules = require_scss_highlight_rules().ScssHighlightRules;
    var LessHighlightRules = require_less_highlight_rules().LessHighlightRules;
    var CoffeeHighlightRules = require_coffee_highlight_rules().CoffeeHighlightRules;
