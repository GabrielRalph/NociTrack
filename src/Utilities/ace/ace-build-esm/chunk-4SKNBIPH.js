...
var require_keys = __commonJS({
  "src/lib/keys.js"(exports) {
    ...
    for (j in Keys.FUNCTION_KEYS) {
      name = Keys.FUNCTION_KEYS[j].toLowerCase();
      Keys[name] = parseInt(j, 10);
    }
    var name;
    var j;
    for (j in Keys.PRINTABLE_KEYS) {
      name = Keys.PRINTABLE_KEYS[j].toLowerCase();
      Keys[name] = parseInt(j, 10);
    }
    var name;
    var j;
