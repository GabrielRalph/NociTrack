...
// src/mode/vbscript_highlight_rules.js
var require_vbscript_highlight_rules = __commonJS({
  "src/mode/vbscript_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/folding/vbscript.js
var require_vbscript = __commonJS({
  "src/mode/folding/vbscript.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/vbscript.js
var require_vbscript2 = __commonJS({
  "src/mode/vbscript.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var VBScriptHighlightRules = require_vbscript_highlight_rules().VBScriptHighlightRules;
    var FoldMode = require_vbscript().FoldMode;
    var Range = require_range().Range;
    var Mode = function() {
...
export default require_vbscript2();
