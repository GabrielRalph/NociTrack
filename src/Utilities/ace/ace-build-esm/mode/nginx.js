...
// src/mode/nginx_highlight_rules.js
var require_nginx_highlight_rules = __commonJS({
  "src/mode/nginx_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_nginx = __commonJS({
  "src/mode/nginx.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var NginxHighlightRules = require_nginx_highlight_rules().NginxHighlightRules;
