...
// src/mode/sqlserver_highlight_rules.js
var require_sqlserver_highlight_rules = __commonJS({
  "src/mode/sqlserver_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_sqlserver = __commonJS({
  "src/mode/folding/sqlserver.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/sqlserver.js
var require_sqlserver2 = __commonJS({
  "src/mode/sqlserver.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var SqlServerHighlightRules = require_sqlserver_highlight_rules().SqlHighlightRules;
    var SqlServerFoldMode = require_sqlserver().FoldMode;
    var Mode = function() {
...
export default require_sqlserver2();
