...
// src/mode/mysql_highlight_rules.js
var require_mysql_highlight_rules = __commonJS({
  "src/mode/mysql_highlight_rules.js"(exports) {
    var oop = require_oop();
...
var require_mysql = __commonJS({
  "src/mode/mysql.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var MysqlHighlightRules = require_mysql_highlight_rules().MysqlHighlightRules;
    var Mode = function() {
