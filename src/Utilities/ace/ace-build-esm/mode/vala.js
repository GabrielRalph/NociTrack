...
// src/mode/vala_highlight_rules.js
var require_vala_highlight_rules = __commonJS({
  "src/mode/vala_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_vala = __commonJS({
  "src/mode/vala.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var ValaHighlightRules = require_vala_highlight_rules().ValaHighlightRules;
