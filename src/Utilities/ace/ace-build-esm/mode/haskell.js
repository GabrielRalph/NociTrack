...
// src/mode/haskell_highlight_rules.js
var require_haskell_highlight_rules = __commonJS({
  "src/mode/haskell_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_haskell = __commonJS({
  "src/mode/haskell.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var HaskellHighlightRules = require_haskell_highlight_rules().HaskellHighlightRules;
