...
// src/mode/prisma_highlight_rules.js
var require_prisma_highlight_rules = __commonJS({
  "src/mode/prisma_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_prisma = __commonJS({
  "src/mode/prisma.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var PrismaHighlightRules = require_prisma_highlight_rules().PrismaHighlightRules;
