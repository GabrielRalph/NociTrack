...
// src/mode/raku_highlight_rules.js
var require_raku_highlight_rules = __commonJS({
  "src/mode/raku_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
    ...
    var RakuHighlightRules = function() {
      ...
      var ops_char = { token: "keyword.operator", regex: "=|<|>|\\+|\\*|-|/|~|%|\\?|!|\\^|\\.|\\:|\\,|\xBB|\xAB|\\||\\&|\u269B|\u2218" };
      var constants_unicode = { token: "constant.language", regex: "\u{1D452}|\u03C0|\u03C4|\u221E" };
...
var require_raku = __commonJS({
  "src/mode/raku.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var RakuHighlightRules = require_raku_highlight_rules().RakuHighlightRules;
