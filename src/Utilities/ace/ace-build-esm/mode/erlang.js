...
var require_erlang_highlight_rules = __commonJS({
  "src/mode/erlang_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
var require_erlang = __commonJS({
  "src/mode/erlang.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var ErlangHighlightRules = require_erlang_highlight_rules().ErlangHighlightRules;
