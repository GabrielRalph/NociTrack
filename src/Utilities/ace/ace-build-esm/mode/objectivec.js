...
// src/mode/objectivec_highlight_rules.js
var require_objectivec_highlight_rules = __commonJS({
  "src/mode/objectivec_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
    var DocCommentHighlightRules = require_doc_comment_highlight_rules().DocCommentHighlightRules;
    var CHighlightRules = require_c_cpp_highlight_rules().c_cppHighlightRules;
...
var require_objectivec = __commonJS({
  "src/mode/objectivec.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var ObjectiveCHighlightRules = require_objectivec_highlight_rules().ObjectiveCHighlightRules;
