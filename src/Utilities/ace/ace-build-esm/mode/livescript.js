...
// src/mode/livescript.js
var require_livescript = __commonJS({
  "src/mode/livescript.js"(exports) {
    var identifier;
    var LiveScriptMode;
    var keywordend;
    var stringfill;
    ...
    exports.Mode = LiveScriptMode = (function(superclass) {
      ...
      function LiveScriptMode2() {
        var that;
        this.$tokenizer = new (require_tokenizer()).Tokenizer(LiveScriptMode2.Rules);
        if (that = require_matching_brace_outdent()) {
