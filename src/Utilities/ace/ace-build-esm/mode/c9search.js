...
// src/mode/c9search_highlight_rules.js
var require_c9search_highlight_rules = __commonJS({
  "src/mode/c9search_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/folding/c9search.js
var require_c9search = __commonJS({
  "src/mode/folding/c9search.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/c9search.js
var require_c9search2 = __commonJS({
  "src/mode/c9search.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var C9SearchHighlightRules = require_c9search_highlight_rules().C9SearchHighlightRules;
    var MatchingBraceOutdent = require_matching_brace_outdent().MatchingBraceOutdent;
    var C9StyleFoldMode = require_c9search().FoldMode;
    var Mode = function() {
...
export default require_c9search2();
