...
// src/mode/haskell_cabal_highlight_rules.js
var require_haskell_cabal_highlight_rules = __commonJS({
  "src/mode/haskell_cabal_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/folding/haskell_cabal.js
var require_haskell_cabal = __commonJS({
  "src/mode/folding/haskell_cabal.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/haskell_cabal.js
var require_haskell_cabal2 = __commonJS({
  "src/mode/haskell_cabal.js"(exports) {
    var oop = require_oop();
    var TextMode = require_text().Mode;
    var CabalHighlightRules = require_haskell_cabal_highlight_rules().CabalHighlightRules;
    var FoldMode = require_haskell_cabal().FoldMode;
    var Mode = function() {
...
export default require_haskell_cabal2();
