...
// src/commands/multi_select_commands.js
var require_multi_select_commands = __commonJS({
  "src/commands/multi_select_commands.js"(exports) {
...
// src/mouse/multi_select_handler.js
var require_multi_select_handler = __commonJS({
  "src/mouse/multi_select_handler.js"(exports) {
    ...
    (function() {
      ...
      this.transposeSelections = function(dir) {
        ...
        for (var i = all.length; i--; ) {
          var range = all[i];
          if (range.isEmpty()) {
            let tmp2 = session.getWordRange(range.start.row, range.start.column);
            range.start.row = tmp2.start.row;
            range.start.column = tmp2.start.column;
            range.end.row = tmp2.end.row;
            range.end.column = tmp2.end.column;
          }
        }
