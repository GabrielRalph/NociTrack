...
// src/mode/csound_preprocessor_highlight_rules.js
var require_csound_preprocessor_highlight_rules = __commonJS({
  "src/mode/csound_preprocessor_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
...
// src/mode/csound_score_highlight_rules.js
var require_csound_score_highlight_rules = __commonJS({
  "src/mode/csound_score_highlight_rules.js"(exports) {
    "use strict";
    var oop = require_oop();
    var CsoundPreprocessorHighlightRules = require_csound_preprocessor_highlight_rules().CsoundPreprocessorHighlightRules;
...
export {
  require_csound_preprocessor_highlight_rules,
